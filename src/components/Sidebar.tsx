...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar panel */}
      <div
        className={`w-[230px] bg-[var(--ink)] text-gray-200 flex flex-col h-screen p-6 transition-transform duration-300 fixed left-0 top-0 z-50 rounded-r-3xl lg:sticky lg:translate-x-0 lg:z-auto ${
